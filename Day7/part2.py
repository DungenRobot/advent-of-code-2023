...
def type_score(hand_array: list, num_jokers: int):
    """
    ...
    match hand_array[0][0] + num_jokers:
        #five of a kind
        case 5: return 6
        #four of a kind
        case 4: return 5
...
def score_hand(hand: str):
    ...
    score = raw_score(hand) + (type_score(hand_array, num_jokers) * 1_000_000)
